          ...
          <div className="flex flex-col sm:flex-row items-center sm:items-start gap-5">
            ...
            <div className="flex-1 text-center sm:text-left">
              <div className="flex items-center justify-center sm:justify-start gap-2">
                <h2 className="text-xl font-bold text-gray-900 dark:text-white">{userAcc.username}</h2>
                {userAcc.verified && <IconVerified className="w-5 h-5 text-blue-500" />}
              </div>
              <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">{userAcc.followers.length} followers</p>
              <p className="text-sm text-gray-600 dark:text-gray-300 mt-1">{userAcc.user_description}</p>
            ...
            <button className="px-4 py-2 text-sm font-medium bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors">Edit Profile</button>
          </div>
        </div>
          ...
          <>
            {userPosts.length > 0 && (
              <section className="mb-8">
                <h2 className="text-lg font-semibold text-gray-900 dark:text-white mb-3">{userPosts.length} posts</h2>
            ...
            {userHistory.length > 0 && (
              <section className="mb-8">
                <h2 className="text-lg font-semibold text-gray-900 dark:text-white mb-3">{userHistory.length} viewed</h2>
                <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-4">
            ...
            {userLiked.length > 0 && (
              <section className="mb-8">
                <h2 className="text-lg font-semibold text-gray-900 dark:text-white mb-3">{userLiked.length} liked</h2>
                <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-4">
