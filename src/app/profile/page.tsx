        ...
        children={
          <div className="ml-6 lg:ml-0">
              ...
              <div className="flex flex-col lg:flex-row items-center justify-center lg:justify-start">
                ...
                <div className="flex flex-col items-center lg:items-start justify-center">
                  ...
                  <p className="text-lg font-semibold text-gray-600">
                    {userAcc.followers.length} followers
                  </p>
                  <p className="text-sm font-semibold text-black">
                    {userAcc.user_description}
                  </p>
                </div>
              </div>
            ...
            <div className="flex items-center justify-center lg:items-start lg:justify-start flex-wrap gap-12 pt-6 lg:pl-5">
              ...
              <Link href={userAcc.socials.github}>
                <img
              ...
              <Link href={userAcc.socials.twitter}>
                <img
              ...
              <Link href={userAcc.socials.youtube}>
                <img
              ...
              <Link href={userAcc.socials.instagram}>
                <img
