  ...
  return (
    ...
    >
      ...
      <div className="px-6 py-4">
        ...
        <button
          onClick={() => router.push(`/profile/${data.user.user_id}`)}
          className="flex"
        >
          <div className="flex space-x-2">
            ...
            <div className="font-semibold text-lg text-gray-600 relative">
              <p className="relative group">{data.user.username}</p>
            </div>
